            ...
            <div class="row mt-5 justify-content-center">
                <div class="col-12">
                    <div class="title-heading text-center">
                        <h5 class="heading fw-semibold sub-heading text-white title-dark">Edit Profile</h5>
                        <p class="text-white-50 para-desc mx-auto mb-0">Edit your profile</p>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
...
import profile from '@/components/creator/creator-profile-edit.vue';
